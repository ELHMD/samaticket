...
<div class="login">
	<form name="form1" action="Sign up.php" method="POST" onsubmit="return checkForm(this);">
      ...
      <?php
       ...
       ?>
			<label for="signup">Nom & Prenom</label>
      ...
      <label for="tel">Tel</label>
			<input type="number" name="tel" id="first_name" class="form-control input-block"  placeholder="Enter tel" tabindex="0" autocapitalize="off" autocorrect="off" autofocus="autofocus" required="Name">
			<label for="cni">NIN</label>
			<input type="number" name="tel" id="first_name" class="form-control input-block"  placeholder="Enter tel" tabindex="0" autocapitalize="off" autocorrect="off" autofocus="autofocus" required="Name">
			-->
	...
	<p class="new">
		<a data-ga-click="Sign in, switch to sign in" href="Sign in.php" style="color: white;">Se Conneter</a>
	</p>
</div>
