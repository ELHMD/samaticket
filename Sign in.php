...
<div class="login">
	...
	<p class="new">
		<i>
		   <a data-ga-click="Sign in, switch to sign up" href="Signup.php" style="color: white;">Creer un compte</a> ou 
		   <a  href="forgetpwd.php" style="color: white;">Mot de pass oubli&eacute;</a> 
