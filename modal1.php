<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h2 style="font-size: 23px;">Veuillez vous connecter pour l'achat de Tickets</h2>
    </div>

    <div class="login">
      <form action="tour(cor).php" method="POST">
        <div class="head">
          <h1 style="color: black;"><b>Connexion</b></h1>
        </div>
        <div class="bd1">
      ...
      <p class="new" id="p">
        "Nouveau compte"<i>
        <a data-ga-click="Sign in, switch to sign up" href="Signup.php" id="a" style="color: #2675ae;">Creer un compte</a></i>
        <br>
        "Password oublier"<i>
        <a  href="forgetpwd.php" id="a" style="color: #2675ae;">pass oublier</a></i>
      </p>
    </div>
